...
static void spock_quad(GCanvas* canvas) {
    ...
    auto shader = GCreateBitmapShader(bitmap, GMatrix::Scale(1/w, 1/h), GShader::kMirror);
...
static void color_quad(GCanvas* canvas) {
    const GColor r  = { 1, 0, 0, 1 };
    const GColor rg = { 1, 1, 0, 1 };
    const GColor g  = { 0, 1, 0, 1 };
    const GColor gb = { 0, 1, 1, 1 };
    const GColor b  = { 0, 0, 1, 1 };
    const GColor br = { 1, 0, 1, 1 };
